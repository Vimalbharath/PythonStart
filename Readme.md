...
September-28-2025 : sw ok,first negative implement,anagram try,variable n^n,added min,variable slide try,failing,video max confuse,6 line code for max, min not exactly = problem,

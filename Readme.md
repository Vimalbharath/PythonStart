...
September-19-2025 : Subset variations,code rec 0/1 Knapsack,added memo,table without loop,loop ans wrong,only for 1 works,gemini corrected 3 line,subset sum table try,debuged table[i-1]j-arr[i-1]],
